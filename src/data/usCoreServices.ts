...
export const US_HOMEPAGE_SPOTLIGHTS: readonly USHomepageSpotlight[] = [
  ...
  },
  {
    ...
    description:
      'Vendor scheduling and facility project support—including communication, progress tracking, documentation, and on-site coordination for Indiana facility support activities alongside your existing service partners.',
    ...
    cta: 'View vendor & project coordination',
  },
  {
...
export const US_CORE_SERVICES: readonly USCoreService[] = [
  ...
  },
  {
    ...
    href: '/us/services/vendor-coordination',
    navLabel: 'Vendor & Project Coordination',
    navSubtext: 'Scheduling, tracking & on-site sync',
    summary: 'Vendor scheduling and facility project support for Indiana warehouses and commercial sites.',
    headline: 'Vendor & Project Coordination',
    body: 'Phixall provides vendor communication and facility project support for warehouses, logistics centers, and commercial facilities in Indiana. We help schedule visits, organize facility support work, track progress, document activities, and keep vendors and site contacts aligned under one desk.',
    capabilities: [
      'Vendor Communication: Scheduling vendor visits, relaying site access information, and maintaining basic correspondence logs.',
      'Facility Project Support: Aligning schedules, tracking progress with simple milestone checklists, and documenting facility support activities as directed by site management.',
      'On-Site Assistance: Day-of coordination during walk-throughs, deliveries, and vendor check-ins so stakeholders stay informed and work stays organized.',
    ],
