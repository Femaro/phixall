          ...
          <div className="grid items-center gap-12 lg:grid-cols-2">
            <div>
              <div className="inline-flex items-center gap-2 border border-white/20 bg-white/10 px-4 py-2 text-sm font-semibold uppercase tracking-wider text-white backdrop-blur-sm">
                ...
                Enterprise programs for warehouse & logistics networks
              </div>
              <h1 className="mt-6 text-5xl font-bold leading-tight tracking-tight text-white lg:text-6xl">
                ...
                <span className="block text-[#3498db]">Coordinated in Indiana, delivered on your sites</span>
              </h1>
              <p className="mt-6 text-lg leading-relaxed text-white/90">
                We align program management with warehouse and distribution reality—electrical, plumbing, carpentry, painting, and
                supply chain support—so maintenance, installs, and procurement keep your operation moving without surprise gaps.
              </p>
