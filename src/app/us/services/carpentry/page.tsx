    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="bg-gradient-to-br from-amber-900 to-yellow-900 py-20">
        <div className="mx-auto max-w-4xl px-6 text-center lg:px-8">
          ...
          <div className="mt-10">
            <Link href="/us/contact" className="inline-flex items-center gap-2 border-2 border-white bg-white px-8 py-4 text-base font-bold uppercase tracking-wide text-amber-900 transition-all hover:bg-white/90">
              Contact us
