        ...
        <div className="mx-auto max-w-7xl px-6 py-20 lg:px-8">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-neutral-600">
              We are building a platform where skilled Phixers thrive
            </p>
          </div>
          <div className="mt-16 grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              },
              {
                ...
                title: '24/7 Support',
                description: 'Get help whenever you need it. Our dedicated Phixer support team is here to ensure your success.',
              },
            ].map((benefit) => (
            ...
            <div>
              ...
              <ul className="mt-8 space-y-4">
                {[
                  ...
                  'Bonus incentives for top-rated Phixers',
                ].map((item) => (
